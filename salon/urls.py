...
urlpatterns = [
    ...
    path("procedures/create/", ProcedureCreateView.as_view(), name="procedure-create"),
    path("procedures/<int:pk>/update/", ProcedureUpdateView.as_view(), name="procedure-update"),
